...
namespace Netherlands3D.Credentials
{
    public interface ICredentialHandler
    {
        ...
        public UnityEvent<Uri, StoredAuthorization.StoredAuthorization> OnAuthorizationUnchanged { get; set; } 
        public StoredAuthorization.StoredAuthorization Authorization { get; }
