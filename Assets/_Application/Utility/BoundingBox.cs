...
namespace Netherlands3D.Twin.Utility
{
    public class BoundingBox
    {
        ...
        public static BoundingBox RDBounds => new BoundingBox(new Coordinate(CoordinateSystem.RD, 482.06d, 3066602.42d), new Coordinate(CoordinateSystem.RD, 284182.97d, 637049.52d));
    }
}