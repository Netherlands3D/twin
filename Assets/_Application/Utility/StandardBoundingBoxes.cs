...
namespace Netherlands3D.Twin.Utility
{
    public static class StandardBoundingBoxes
    {
        ...
        public static BoundingBox Wgs84_LatLonBounds => new BoundingBox(new Coordinate(CoordinateSystem.WGS84_LatLon, 50.8037d, 3.31497d), new Coordinate(CoordinateSystem.WGS84_LatLon, 53.5104d, 7.09205d));
    }
}
