...
namespace Netherlands3D.Twin.Cameras.Input
{
    public abstract class BaseCameraInputProvider : MonoBehaviour
    {
        [HideInInspector] public bool ingoringInput = false;
        [HideInInspector] public bool lockDraggingInput = false;
        [HideInInspector] public bool isDragging = false;

        [Header("Invoke events")] public FloatEvent horizontalInput;
