...
namespace Netherlands3D.CityJson.Structure
{
    ...
    public class CitySurface : CityBoundary
    {
        ...
        public List<int> materialIndices = new(); // the theme names ar stored in the Geometry object to reduce duplicate memory allocations for the theme in each surface
