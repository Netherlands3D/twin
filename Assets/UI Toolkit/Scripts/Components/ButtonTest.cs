...
{
    [UxmlElement]
    public partial class ButtonTest : UnityEngine.UIElements.Button
    {
        ...
        {
            this.ReplacePrefixedValueInClassList("button-test-type-", buttonType.ToString().ToKebabCase());
            this.ReplacePrefixedValueInClassList("button-test-style-", buttonStyle.ToString().ToKebabCase());
            this.ReplacePrefixedValueInClassList("button-test-icon-position-", buttonIconPosition.ToString().ToKebabCase());
        }
