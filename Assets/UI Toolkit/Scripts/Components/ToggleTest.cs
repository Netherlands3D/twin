...
{
    [UxmlElement]
    public partial class ToggleTest : UnityEngine.UIElements.Toggle
    {
        ...
        {
            this.ReplacePrefixedValueInClassList("toggleTest-type-", toggleType.ToString().ToKebabCase());
            this.ReplacePrefixedValueInClassList("toggleTest-style-", toggleStyle.ToString().ToKebabCase());
            this.ReplacePrefixedValueInClassList("toggleTest-icon-position-", toggleIconPosition.ToString().ToKebabCase());
        }
    }
}