...
public class ObjImportManager : MonoBehaviour
{
    ...
    [Header("Result")]
    [SerializeField] UnityEvent<GameObject> CreatedMoveableGameObject;
    [SerializeField] UnityEvent<GameObject> CreatedImmoveableGameObject;

    [Header("Progress")]
    [SerializeField] UnityEvent<bool> busy;
    ...
    [SerializeField] UnityEvent<string> alertmessage;
    ...
    void OnOBJImported(GameObject returnedGameObject)
    {
        ...
        if (canBemoved)
        {
            CreatedMoveableGameObject.Invoke(returnedGameObject);
        }
        else
        {
