...
namespace Netherlands3D.SelectionTools
{
    ...
    public class PolygonVisualiser : MonoBehaviour
    {
        ...
        public UnityEvent<GameObject> createdPolygonGameObject;
        public UnityEvent<List<Vector3>> polygonReselected; //sends list to PolygonSelection for reselection
        ...
        public void CreatePolygons(List<List<Vector3>> contours)
        {
            ...
            createdPolygonGameObject.Invoke(polygonVisualisation.gameObject);
        }
        ...
        private void InvokeReselectPolygonEvent(PolygonVisualisation polygonToReselect)
        {
            ...
            polygonReselected.Invoke(polygonToReselect.Polygons[0] as List<Vector3>);
            selectedPolygon = polygonToReselect;
        }


        public void UpdateSelectedPolygon(List<Vector3> newPolygon)
        {
            if (selectedPolygon)
