...
namespace Netherlands3D.SerializableGisExpressions
{
    public partial class Expression
    {
        ...
        public static Expression Abs(object v) => new(ExpressionEvaluator.operationMap[typeof(AbsOperation)], v);
        public static Expression Boolean(params object[] values) => new(ExpressionEvaluator.operationMap[typeof(BooleanOperation)], values);
        ...
        //// Feature lookup
        public static Expression Get(string key) => null;
        public static Expression In(object needle, object haystack) => null;

        //// Logic
        //public static Expression Not(object v) => new(Operators.Not, v);
        public static Expression EqualTo(object a, object b) => null;
