...
namespace Netherlands3D.LayerStyles.Expressions.Operations
{
    ...
    /// <c>true</c> if the first operand is less than or equal to the second.
    /// </summary>
    /// <seealso href="https://docs.mapbox.com/style-spec/reference/expressions/#%3C%3D">
    ...
    public static class LessThanOrEqualOperation
    {
        ...
        /// <returns>
        ///   <c>true</c> if the first operand is less than or equal to the second; otherwise <c>false</c>.
        /// </returns>
