...
* Added IsValid check to check if a coordinate could be a EPSG7415 (RDNAP) Coordinate.
* Changed default axis for northing to value 2 (y)
* UndefinedOperations now have an axisCount of 3 so height won't be ignored/set to 0.
* ToUnity now returns the coordinate values in order as a Vector3

## \[2.2.0] 10-07-2025

### Added

* Added support for WGS84\_NAP\_ECEF
...
* Created an overload method for FindCoordinate
...
* Added a JSON converter to fix compatability of serialized coordinates after replacing the points array with value fields

## \[2.0.1] 07-04-2025

### Added

* Added support for epsg 7415 (RDNAP)

## \[2.0.0] 1-04-2025

### Added

* undefined operations class

### Removed

* the unity enum value
...
* several coordainteSystems had incorrect conversions to and from WGS84\_Lat\_Lon\_Height

## \[1.6.1] 31-05-2024

### Fixed

* lattitude an longitude 2D coordinatesystems return a wgs84\_LatLonHeight-coordinate without elevation

## \[1.6.0] 31-05-2024

### Added

* Added CoordinateSystem CRS84\_LonLat
...
* RDNAP\_Operations returned the wrong name.
...
* WGS84\_ECEF\_Operations and ETRS89\_ECEF\_Operations didn't return corrent extraLattitude and extraLongitude values.
